...
df = pd.read_csv(r"D:\CIT College\5th Semester\DarkPattern Hackathon\dark-patterns-recognition\train_classifier\dark_patterns.csv")
...
dump(clf, 'category_classifier_random_forest.joblib')
dump(count_vect, 'category_vectorizer_random_forest.joblib')